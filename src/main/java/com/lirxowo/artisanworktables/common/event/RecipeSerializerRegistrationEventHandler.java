...
import com.lirxowo.artisanworktables.common.recipe.serializer.*;
  ...
  public void on(RegisterEvent event) {
    ...
    for (EnumType type : EnumType.values()) {
      ...
      event.register(Registries.RECIPE_SERIALIZER,
          ResourceLocation.fromNamespaceAndPath("artisanworktables", name + "_shaped"),
          () -> shapedSerializer);
      ...
      event.register(Registries.RECIPE_SERIALIZER,
          ResourceLocation.fromNamespaceAndPath("artisanworktables", name + "_shapeless"),
          () -> shapelessSerializer);
    }
  }
}