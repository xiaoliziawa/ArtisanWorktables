...
import com.lirxowo.artisanworktables.common.block.*;
...
public class BlockRegistrationEventHandler {
  ...
  public void on(RegisterEvent event) {
    ...
    event.register(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("artisanworktables", ToolboxBlock.NAME),
        () -> toolboxBlock);
    event.register(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("artisanworktables", ToolboxMechanicalBlock.NAME),
  ...
  private void register(RegisterEvent event, EnumTier tier, String name, Block block) {
    ...
    event.register(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("artisanworktables", registryName), () -> block);
