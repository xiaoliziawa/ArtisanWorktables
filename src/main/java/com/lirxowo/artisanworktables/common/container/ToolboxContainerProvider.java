...
import com.lirxowo.artisanworktables.common.block.ToolboxBaseBlock;
...
public class ToolboxContainerProvider
  ...
  public Component getDisplayName() {
    ...
    return Component.translatable("block.artisanworktables." + BuiltInRegistries.BLOCK.getKey(this.block).getPath());
  }
