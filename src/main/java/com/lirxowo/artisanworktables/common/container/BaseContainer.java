...
import com.lirxowo.artisanworktables.common.container.slot.*;
import com.lirxowo.artisanworktables.common.network.SCPacketWorktableContainerJoinedBlockBreak;
...
public abstract class BaseContainer
  ...
  private boolean swapItemStack(int originSlotIndex, int targetSlotIndex, boolean swapOnlyEmtpyTarget) {
    ...
    if (ItemStack.isSameItemSameTags(originStack, targetStack)) {
      return true;
    }
