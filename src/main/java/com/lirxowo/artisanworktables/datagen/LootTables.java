...
//    this.createAndSaveTable(cache, ArtisanWorktablesMod.Blocks.MECHANICAL_TOOLBOX, ToolboxMechanicalBlock.NAME);
  ...
  private void createAndSaveTable(@Nonnull CachedOutput cache, Block block, String resourceLocationPath) {
    ...
    Path path = this.output.getOutputFolder().resolve("data/" + ArtisanWorktablesMod.MOD_ID + "/loot_tables/blocks/" + resourceLocationPath + ".json");
  ...
  public String getName() {
    return "ArtisanWorktables LootTables";
  }
}
