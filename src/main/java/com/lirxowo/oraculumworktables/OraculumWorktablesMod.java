...
import com.lirxowo.oraculumworktables.client.ClientProxy;
...
import com.lirxowo.oraculumworktables.common.tile.WorkshopBlockEntity;
...
@Mod(OraculumWorktablesMod.MOD_ID)
public class OraculumWorktablesMod {
  ...
  private static OraculumWorktablesMod instance;

  private final IProxy proxy;

  public OraculumWorktablesMod(IEventBus modEventBus, ModContainer modContainer) {
    OraculumWorktablesMod.instance = this;
  ...
  public static OraculumWorktablesMod getInstance() {
    return OraculumWorktablesMod.instance;
  }

  public static IProxy getProxy() {
    return OraculumWorktablesMod.getInstance().proxy;
  }
