...
import com.lirxowo.oraculumworktables.common.util.HashCodeHelper;
...
public class ArtisanRecipeBuilder {
  ...
  public ArtisanRecipeBuilder addTool(Ingredient tool, ItemStack matchStack, int damage, boolean matchNbt) {

    this.tools.add(new ToolEntry(tool, matchStack, damage, matchNbt, null));
    return this;
  }
  ...
  public String getGeneratedName(IntSet usedHashSet, Consumer<String> logger) {
    ...
    while (usedHashSet.contains(hash)) {
      ...
      if (OraculumWorktablesModCommonConfig.enableDuplicateRecipeHashWarnings) {
