...
public class ReferenceTexture {
  ...
  public static final ResourceLocation RESOURCE_LOCATION_GUI_ELEMENTS = ResourceLocation.fromNamespaceAndPath(
  ...
  public static final ResourceLocation RESOURCE_LOCATION_TOOLBOX = ResourceLocation.fromNamespaceAndPath(
      OraculumWorktablesMod.MOD_ID,
  ...
  private static final ResourceLocation RESOURCE_LOCATION_TOOLBOX_MECHANICAL = ResourceLocation.fromNamespaceAndPath(
      OraculumWorktablesMod.MOD_ID,
